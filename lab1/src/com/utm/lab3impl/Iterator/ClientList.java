package com.utm.lab3impl.Iterator;

import java.util.*;

public class ClientList<E> implements List<E> {
    ...
    public ClientList(Collection<E> objectsCollection) {
    ...
    public boolean addAll(Collection<? extends E> collection) {
        ...
        System.arraycopy(c, 0, objectsArray, size, size + len - size);
        size += len;
        return true;
    }
    ...
    public boolean addAll(int i, Collection<? extends E> collection) {
        ...
        System.arraycopy(c, 0, objectsArray, i, i + len - i);
    ...
    public boolean retainAll(Collection<?> collection) {
        ...
        ClientList<Object> toExclude = new ClientList<>();
    ...
    public String toString() {
        return "ClientList{" + "size=" + size + ", capacity=" + capacity + ", clients=" + Arrays.toString(Arrays.copyOf(objectsArray, size)) + '}';
    }
    ...
    class ListObjectIterator extends ObjectIterator implements ListIterator<E> {
        ...
        public void set(E element) {
            ...
            ClientList.this.set(cursor - 1, element);
        }

        @Override
        public void add(E element) {
            ClientList.this.add(cursor, element);
            cursor++;
        }
    }

    private class SubList<E> extends AbstractList<E> {
        private final ClientList<E> root;
        private final SubList<E> parent;
        private final int offset;
        private int size;

        public SubList(ClientList<E> root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
